...
add_files -quiet ./DESIGN.srcs/sources_1/SYS_REG/TEMP_TO_ASIC.sv
add_files -quiet ./DESIGN.srcs/sources_1/UART_CTL/UART_CTL.sv
add_files -quiet ./DESIGN.srcs/sources_1/UART_CTL/UART_DECODE.sv
add_files -quiet ./DESIGN.srcs/sources_1/USER_IP/Driver/XADC/XADC_TEMP.sv
add_files -quiet ./DESIGN.srcs/sources_1/USER_IP/Function/ASCII_TO_HEX/ASCII_TO_HEX.sv
add_files -quiet ./DESIGN.srcs/sources_1/USER_IP/Function/B_TO_BCD/B_TO_BCD.sv
...
# add IP file
add_files -quiet ./DESIGN.srcs/sources_1/ip/DSP_13x10sub22_out12_m23l12/DSP_13x10sub22_out12_m23l12.xci
...
add_files -quiet ./DESIGN.srcs/sources_1/ip/XADC_IP/XADC_IP.xci
...
file copy -force ./DESIGN.runs/impl_1/HS7A35_TOP.bit    ./HS7A35_TOP.bit
